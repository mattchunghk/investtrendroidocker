...
class Test:
    ...
    def bt_get_data(self, start_date, end_date=None):
    ...
    def get_forward_test_result(self):
        self.ft_start_date = datetime.now()
        ft.start_mt5()
        history_orders = ft.get_forward_test_result(self.ft_symbols, self.ft_start_date, self.test_id)
        
        self.ft_roi = history_orders[str(self.ft_symbols[0])]['roi']
        self.ft_profit = history_orders[str(self.ft_symbols[0])]['profit']
        self.ft_entry = history_orders[str(self.ft_symbols[0])]['entry']
        self.ft_exit = history_orders[str(self.ft_symbols[0])]['exit']
        self.ft_over_all = history_orders[str(self.ft_symbols[0])]['over_all']
